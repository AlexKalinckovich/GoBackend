...
import (
	"github.com/brota/gobackend/internal/shared/custom_errors"
	errconsts "github.com/brota/gobackend/internal/shared/custom_errors/abstract_error_code"
	"github.com/brota/gobackend/internal/shared/custom_errors/transport"
)
...
func DefaultFallbackHandler(error, map[string]any) HTTPResponse {
	return NewHTTPResponse(500, map[string]any{
